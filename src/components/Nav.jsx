...
export default function Nav({page,setPage,dark,setDark}) {
 const links=[["home","Explore"],["dashboard","Dashboard"],["analysis","Skin Scan"],["report","Reports"],["resources","Resources"]];
 return <header className="nav">
  <button className="brand" onClick={()=>setPage("home")}>
    <span className="brand-mark">D</span>
    <span>Derma<span>Sathi</span></span>
    </button>
  ...
  <div className="nav-actions">
    ...
    <button className="profile-mini" onClick={()=>setPage("profile")}><UserRound size={16}/> Aditya</button>
    </div>
 </header>
}
